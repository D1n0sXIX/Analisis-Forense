...
Guía de triaje: identifica el escenario y sigue el procedimiento paso a paso. Para tablas de consulta rápida (comandos sueltos, rutas, EventIDs...) ver `Forense-ReferenciaRapida.md`. Para teoría de NTFS/`$MFT` ver `SistemaFicheros.md`.
...
**→ Tablas de referencia rápida (Metadatos, Password Cracking, Esteganografía, Info Volátil, Volatility, Registro, Artefactos de Disco, Navegadores, EventIDs, Checklist proceso malicioso, tabla de Herramientas):** ver `Forense-ReferenciaRapida.md`.
